...
namespace Unity.BossRoom.ConnectionManagement
{
    public struct SessionPlayerData : ISessionPlayerData
    {
        ...
        public SessionPlayerData(ulong clientID, string name, NetworkGuid avatarNetworkGuid, int currentHitPoints = 0, bool isConnected = false, bool hasCharacterSpawned = false, int currentManaPoints = 0)
        {
            ClientID = clientID;
            PlayerName = name;
            PlayerNumber = -1;
